...
import type { Veterinarian } from "@/types/veterinarian" elsewhere
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-card rounded-2xl shadow-xl max-w-md w-full border border-border max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          {}
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Foto do Animal (Opcional)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Veterinário</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Diagnóstico</label>
            <textarea
